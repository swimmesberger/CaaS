...
export class ProductsComponent implements OnDestroy {
  ...
  nextPageQueryParams(productPage: ProductMinimalDtoPagedResult): Params {
    return { paginationDirection: productPage.nextPage?.direction!, reference: productPage.nextPage?.reference!}
  }

  prevPageQueryParams(productPage: ProductMinimalDtoPagedResult): Params {
    return { paginationDirection: productPage.previousPage?.direction!, reference: productPage.previousPage?.reference!}
  }
