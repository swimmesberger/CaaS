...
namespace CaaS.Infrastructure.Generator {
    public class InitializationContext {
        ...
        public const string TenantIdColumnAttributeName = "CaaS.Infrastructure.Base.Mapping.TenantIdColumn";
        public const string JsonColumnAttributeName = "CaaS.Infrastructure.Base.Mapping.JsonColumn";
