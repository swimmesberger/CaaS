...
public class OrderService : IOrderService {
    ...
    public async Task<Entities.Order?> FindOrderById(Guid orderId, CancellationToken cancellationToken = default) {
        var order = await _orderRepository.FindByIdAsync(orderId, cancellationToken);
        return order ?? null;
    }
    
    public async Task<Entities.Order> CreateOrder(Guid customerId ,CancellationToken cancellationToken = default) {
    ...
    public async Task<Entities.Order> AddProductToOrder(Guid orderId, Guid productId, int productQuantity, CancellationToken cancellationToken = default) {
    ...
    public Task<Entities.Order> CreateOrderFromCart(Guid cartId, CancellationToken cancellationToken = default) {
